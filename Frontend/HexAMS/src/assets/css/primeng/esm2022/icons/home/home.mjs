...
export class HomeIcon extends BaseIcon {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.2.2", ngImport: i0, type: HomeIcon, deps: null, target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "17.2.2", type: HomeIcon, isStandalone: true, selector: "HomeIcon", usesInheritance: true, ngImport: i0, template: `
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.2.2", ngImport: i0, type: HomeIcon, decorators: [{
            type: Component,
            args: [{
                    selector: 'HomeIcon',
                    standalone: true,
